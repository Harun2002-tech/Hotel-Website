import { FadeIn, SlideUp, StaggerContainer, StaggerItem } from "@/components/ui/MotionDiv";
                ...
                <StaggerItem key={i}>
                  ...
                  >
                    <SafeImage
                      ...
                      alt={item.title.en}
                      fill
                      className="object-cover group-hover:scale-110 transition-transform duration-500 ease-out transform-gpu will-change-transform"
